export const KhoTruyenAdapter = {
  name: 'KhoTruyen Adapter',
  domains: [
    'khotruyenpro.com', 'khotruyen.com', 'khotruyenplus.com',
  ],
  ...
  async getMangaInfo(url) {
    ...
    if (raw) {
      title = raw
        .replace(/[-|].*KhoTruyen.*/gi, '')
        .replace(/[-|].*Kho Truyện.*/gi, '')
    ...
    return { title, chapterNumber, sourceName: 'KhoTruyen', sourceUrl: url, html };
  },
