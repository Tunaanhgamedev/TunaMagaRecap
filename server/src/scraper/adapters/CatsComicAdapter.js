export const CatsComicAdapter = {
  name: 'CatsComic Adapter',
  domains: ['catscomic.com', 'catscomic.net'],
  ...
  async getMangaInfo(url) {
    ...
    return { title, chapterNumber, sourceName: 'CatsComic', sourceUrl: url, html };
  },
  ...
  async getChapterImages(url, htmlContent) {
    ...
    while ((m = regex.exec(html)) !== null) {
      ...
      if (
        ...
        !src.includes('thumb') && !src.includes('cover-')
      ) {
